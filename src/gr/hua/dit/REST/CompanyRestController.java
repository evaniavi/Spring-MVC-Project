...
public class CompanyRestController {
		...
		public Positions addPositions(@RequestParam("compName") String compName,
			...
			Positions thePosition = new Positions(compName, category , false , null,null);
		...
		public boolean saveStudentForPosition(@RequestParam("posID") int posID,@RequestParam("studentID") int studentID){
